...
// Public Integration Webhooks (PBX & Messaging Webhooks)
...
Route::middleware(['crm.auth'])->group(function () {
    ...
    Route::post('/queue/bulk-delete', [QueueController::class, 'bulkDelete']);

    // Opportunities & Pipelines
    Route::get('/opportunities', [OpportunityController::class, 'index']);
    Route::get('/opportunities/stages', [OpportunityController::class, 'getStages']);
    Route::post('/opportunities', [OpportunityController::class, 'store']);
    Route::post('/opportunities/bulk-delete', [OpportunityController::class, 'bulkDelete']);
    ...
    Route::get('/whatsapp/contact-history', [WhatsAppController::class, 'contactHistory']);
    ...
    // Master Catalogs CRUD (Developers, Projects, Property Types, Communities, Opportunity Types)
    ...
    Route::post('/owner-data/bulk-assign', [OwnerDataController::class, 'bulkAssign']);
    Route::post('/owner-data/import-preview', [OwnerDataController::class, 'preview']);
