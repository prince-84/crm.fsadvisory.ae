            ...
            <div className="bg-white border border-[#E8E4DC] rounded-lg p-6 space-y-4 shadow-2xs">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-2.5 bg-[#FAF8F5] border border-[#E8E4DC] rounded-md text-xs text-[#1A1A1A] resize-y leading-relaxed font-sans whitespace-pre-line focus:bg-white focus:outline-none focus:border-[#C8A147]"
                />
              </div>
            </div>
