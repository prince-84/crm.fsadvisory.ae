...
export default function LeadPoolPage() {
  ...
  const VISIBILITY_STORAGE_KEY = 'lead_pool_column_visibility_v2';
  const ORDER_STORAGE_KEY = 'lead_pool_column_order_v2';
  ...
  const updateColumnVisibility = (newVisibility: Record<string, boolean>) => {
    ...
    saveGlobalColumnSettings('lead_pool', { visibility: newVisibility, order: columnOrder });
  };
  ...
  const updateColumnOrder = (newOrder: string[]) => {
    ...
    saveGlobalColumnSettings('lead_pool', { visibility: columnVisibility, order: newOrder });
  };
  ...
  useEffect(() => {
    ...
    getGlobalColumnSettings('lead_pool').then((globalSettings) => {
